...
![Виджет квот Quickshell](docs/widget-preview.png)
...
- Оставшийся процент и время сброса дополнительного окна (secondary window) Codex при наличии.
- Доступные сбросы лимитов (rate limit resets) Codex и время их истечения при наличии.
